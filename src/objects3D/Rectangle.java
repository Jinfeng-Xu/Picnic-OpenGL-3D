...
public class Rectangle {
    ...
    public void DrawRectangle(float radius, float height, int nSegments) {
        for (float i = 0; i < nSegments; i += 1) {
            ...
            Vector4f v = new Vector4f(x1 - x2, 0, 0, 0);
            Vector4f w = new Vector4f(x1, y1, 0, 0);
            glNormalByVW(v,w);
            // Set normal for lights
            GL11.glVertex3f(x1, 0, 0);
            GL11.glVertex3f(x2, 0, 0);
            GL11.glVertex3f(0, 0, 0);
            GL11.glEnd();
            // To draw top part
            GL11.glBegin(GL11.GL_TRIANGLES);
            v = new Vector4f(x1 - x2, 0, 0, 0);
            w = new Vector4f(x1, 0, 0, 0);
            glNormalByVW(v,w);
            ...
            GL11.glBegin(GL11.GL_TRIANGLES);
            v = new Vector4f(x1 - x2, 0, 0 - height, 0);
            w = new Vector4f(0, 0, 0 - height, 0);
            glNormalByVW(v,w);
            GL11.glVertex3f(x1, 0, 0);
            GL11.glVertex3f(x2, 0, height);
            GL11.glVertex3f(x1, 0, height);
            GL11.glEnd();
            // To draw bottom triangle part
            GL11.glBegin(GL11.GL_TRIANGLES);
            v = new Vector4f(x1 - x2, 0, 0, 0);
            w = new Vector4f(x1 - x2, 0, 0 - height, 0);
            glNormalByVW(v,w);
            // Set normal for light.
            GL11.glVertex3f(x1, 0, 0);
            GL11.glVertex3f(x2, 0, 0);
